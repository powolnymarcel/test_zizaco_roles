...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"v-paginator text-center\">\r\n    <button class=\"btn btn-default pull-left \" @click=\"fetchData(prev_page_url)\" :disabled=\"!prev_page_url\">\r\n      {{config.previous_button_text}}\r\n    </button>\r\n    <span>Page {{current_page}} {{config.de}} {{last_page}}</span>\r\n    <button class=\"btn btn-default pull-right \" @click=\"fetchData(next_page_url)\" :disabled=\"!next_page_url\">\r\n      {{config.next_button_text}}\r\n    </button>\r\n  </div>";
