        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="{{ url(LaravelLocalization::getCurrentLocale().'/super_admin') }}">Super Admin</a>

                    </li>
                    @endif
                        @if (!Auth::guest() && Auth::user()->hasRole('formateur'))

                    <li>  <a href="{{ url(LaravelLocalization::getCurrentLocale().'/formateur') }}">{{trans('traduction.formateur')}}</a></li>
